...
export const LocationField: React.FC<Props> = React.memo(
  ({ setLocation, location, error, setError = () => {}, setWarehouse }) => {
    ...
    return (
      <div className="LocationField">
        ...
        >
          {!isEditingMode && location.city && <span>{location.city}</span>}

          {!isEditingMode && !location.city && (
            <span className="LocationField__placeholder">Add location</span>
          )}
